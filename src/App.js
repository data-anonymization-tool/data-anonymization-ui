        ...
        <table>
          {labels.param1 && (
            <tr>
              ...
              <td align="right">
                <input type="text" name="param1" className="input-field" />
              </td>
            </tr>
          )}
          {labels.param2 && (
            <tr>
              ...
              <td align="right">
                <input type="text" name="param2" className="input-field" />
              </td>
            </tr>
          )}
          {labels.param3 && (
            <tr>
              ...
              <td align="right">
                <input type="text" name="param3" className="input-field" />
              </td>
            </tr>
          )}
          {labels.param4 && (
            <tr>
              ...
              <td align="right">
                <input type="text" name="param4" className="input-field" />
              </td>
            </tr>
          )}
